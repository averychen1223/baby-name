...
This file defines the functions needed to process the data
"""
    ...
    with open(filename, "r") as f:
        for line in f:
            ...
            if len(info_lst) == 1:
                ...
                boy_name = info_lst[1].strip()
                girl_name = info_lst[2].strip()
...
def search_names(name_data, target):
    ...
    """
    names = []
    new_target = target.upper()

    for key in name_data:
        if new_target in key.upper():
            names.append(key)
